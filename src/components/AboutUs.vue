<template>
    <div class="px-8 md:px-14 pb-16 pt-5 md:pt-10">
        ...
        <h1 class="text-2xl font-bold text-primary2 cursor-default">
            Profil
        </h1>

        <div class="md:flex justify-between align-middle mt-4">

            <video class="md:w-[50%] h-[48%] mr-2" controls>
                <source src="/public/assets/VIDEOFIX.mp4" type="video/mp4">
        ...
        <h1 class="text-2xl font-bold text-primary2 cursor-default md:mt-10 sm:mt-6 mt-3">
            Tentang Kami
        </h1>
        ...
        <div class="sm:flex md:mt-10 sm:mt-6 mt-3">

            <!-- VISI -->
            <div class="border-2 border-primary2 rounded-md text-center md:mt-0 sm:w-[50%]  sm:mr-2">
                ...
                <div class="relative w-full py-auto md:h-44 sm:h-32 h-24">
            ...
            <!-- MISI -->
            <div class="border-2 border-primary2 rounded-md text-center sm:w-[50%] sm:mt-0 mt-5 sm:ml-2">
                ...
                <div id="default-carousel" class="relative md:h-44 sm:h-32 h-24 w-full" data-carousel="slide">
                    <!-- Carousel wrapper -->
                    <div class="relative h-full overflow-hidden rounded-md text-xs md:text-sm lg:text-base">
                        ...
                        <!-- Item 2 -->
                        <div class="duration-700 ease-in-out h-full flex items-center justify-center" data-carousel-item>
                            <p class="text-center px-5 flex items-center justify-center h-full bg-white cursor-default">Menjunjung tinggi nilai-nilai, kejujuran, komitmen dan tanggung jawab.</p>
                        </div>
                        <!-- item 3 -->
                        <div class="duration-700 ease-in-out h-full flex items-center justify-center" data-carousel-item>
                            <p class="text-center px-5 flex items-center justify-center h-full bg-white cursor-default">Membangun jaringan pemasaran dan dan hubungan kerjasama yang saling menguntungkan.</p>
                        </div>
                        <!-- Item 4 -->
                        <div class="duration-700 ease-in-out h-full flex items-center justify-center" data-carousel-item>
                        ...
                        <!-- Item 5 -->
                        <div class="duration-700 ease-in-out h-full flex items-center justify-center" data-carousel-item>
                            <p class="text-center px-5 flex items-center justify-center h-full bg-white cursor-default">Melayani Sesuai Kebutuhan konsumen.</p>
                        </div>
                        <!-- Item 6 -->
                        <div class="duration-700 ease-in-out h-full flex items-center justify-center" data-carousel-item>
